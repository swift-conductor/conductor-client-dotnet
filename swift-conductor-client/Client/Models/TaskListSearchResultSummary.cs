...
namespace SwiftConductor.Client.Models
{
    ...
    public partial class TaskListSearchResultSummary : IEquatable<TaskListSearchResultSummary>, IValidatableObject
    {
        ...
        public TaskListSearchResultSummary(List<WorkerTask> results = default(List<WorkerTask>), Dictionary<string, long?> summary = default(Dictionary<string, long?>), long? totalHits = default(long?))
        {
