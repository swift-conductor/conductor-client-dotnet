...
namespace SwiftConductor.Client.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkerTask : IEquatable<WorkerTask>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            return this.Equals(input as WorkerTask);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(WorkerTask input)
        {
            if (input == null)
                return false;
