...
namespace SwiftConductor.Client.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkerTaskResult : IEquatable<WorkerTaskResult>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkerTaskResult" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as WorkerTaskResult);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(WorkerTaskResult input)
        {
            if (input == null)
                return false;
